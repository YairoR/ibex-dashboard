...
interface ITimelineVisualProps extends IVisualBaseProps {
}

interface ITimelineVisualState {
}

export default class TimelineVisual extends VisualBase<ITimelineVisualProps, ITimelineVisualState> {
